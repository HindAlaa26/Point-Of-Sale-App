...
class NewSale extends StatelessWidget {
  const NewSale({super.key, required this.text, required this.icon, required this.color, required this.heroTag});
  final String text;
  final IconData icon;
  final Color color;
  final int heroTag;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: textInApp(text:"New Sale",color: Colors.white),
      ),
